...
| --- | --- | --- | --- |
| **B-06** | **EMS reachable?** Confirm login at `https://prod-dev.ems-fitus.cloud/login?callbackUrl=%2F` with the admin account. §4 warns the instance is tunnelled and its data may be reset periodically — capture evidence as you go. | Nothing can be executed against a dead SUT | Step 3 |
