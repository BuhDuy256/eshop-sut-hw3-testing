...
**Date:** 2026-08-03 (regenerated during the Agent Skills demo video session
— content re-verified live against the same source artifacts; no input
changed since the prior dry-run generation, backed up at
`demo-workspace/report-draft.backup-pre-video.md`).
